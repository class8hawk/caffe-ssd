...
save_dir = "models/VGGNet/tky/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/tky/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/tky/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/TKY/results/VOC2007/{}_score/Main".format(os.environ['HOME'], job_name)
