...
model_name = "ResNet_tky_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet/tky/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/tky/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/tky/{}".format(job_name)
...
num_classes = open(label_map_file).read().count('label') # 21
share_location = True
...
num_test_image = len(open(name_size_file).readlines()) #4952
test_batch_size = 1
